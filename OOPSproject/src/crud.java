    ...
    public static void update(String path) {
        ...
        while(i.hasNext()){
            ...
            try {
                ...
                if (ans.next()){
                    query = "UPDATE PATIENTS SET NAME = \'" + tokens[1] +"\'" + ", AGE = \'" + tokens[2] +"\'" + ", SEVERITY = \'" + tokens[3] + "\', RECOVERED = " + tokens[4] +  ", VACCINATED = " + tokens[5] + " WHERE REG_NO = "+tokens[0];
                    s.executeUpdate(query);
                }

                else {
                    query = "INSERT INTO PATIENTS VALUES("+tokens[0]+",\'"+tokens[1]+"\'"+",\'"+tokens[2]+"\'"+",\'"+tokens[3]+"\',"+tokens[4]+ ","+tokens[5] + ")";
                    s.executeUpdate(query);
                }
            } 
